...
RVI = """
#########################################################################                                  
:FileType          rvi ASCII Raven rev225 (v2.9)                                                                             
...
#------------------------------------------------------------------------
#
:StartDate               1979-01-01 00:00:00 # 1954-01-01 00:00:00 
:EndDate                 2000-12-31 00:00:00  
:EvaluationTime          1981-01-01 00:00:00                                                        
# :Duration              20819                                                                                   
:TimeStep                1.0                                                                                   
...
RVP = """
#########################################################################                                  
:FileType          rvp ASCII Raven rev225 (v2.9)                                                                             
:WrittenBy         James Craig & Juliane Mai                                                                       
:CreationDate      June 2019
#
# RAVEN run of WSC/USGS {props[id]} ({props[name]}) using weighted model options                                                             
...
RVC = """
#########################################################################                                  
:FileType          rvc ASCII Raven rev225 (v2.9)                                                                             
:WrittenBy         James Craig & Juliane Mai                                                                       
:CreationDate      June 2019
#
# RAVEN run of WSC/USGS {props[id]} ({props[name]}) using weighted model options                                                        
